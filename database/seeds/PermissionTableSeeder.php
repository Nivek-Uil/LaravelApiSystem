            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'display_name' => '用户管理',
                        'children' => [
                            ['name' => 'system.user.list', 'display_name' => '账号列表'],
                            ['name' => 'system.user.create', 'display_name' => '添加用户'],
                            ['name' => 'system.user.update', 'display_name' => '编辑用户'],
                            ['name' => 'system.user.show', 'display_name' => '查看用户'],
                            ['name' => 'system.user.enable', 'display_name' => '账号启用'],
                            ['name' => 'system.user.disable', 'display_name' => '账号禁用'],
                    ...
                    [
                        ...
                        'children' => [
                            [
                                ...
                                'display_name' => '登录日志',
                                'children' => [
                                    ['name' => 'system.log.login.list', 'display_name' => '登录日志列表'],
                                    ['name' => 'system.log.login.delete', 'display_name' => '删除登录日志']
                                ]
                            ],
                            [
                                ...
                                'display_name' => '操作日志',
                                'children' => [
                                    ['name' => 'system.log.operate.list', 'display_name' => '操作日志列表'],
                                    ['name' => 'system.log.operate.delete', 'display_name' => '删除操作日志']
                                ]
                            ]
                        ]
                    ],
